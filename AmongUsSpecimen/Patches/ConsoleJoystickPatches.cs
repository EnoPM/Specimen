...
internal static class ConsoleJoystickPatches
{
    ...
    private static bool HandleHUDPrefix(ConsoleJoystick __instance)
    {
            ...
            if (!ControllerManager.Instance.IsUiControllerActive)
            {
                ...
                else
                {
                    ...
                    if (!flag)
                    {
                        ...
                        if (PlayerControl.LocalPlayer && PlayerConditions.CanUseVentButtonKeyBind(PlayerControl.LocalPlayer) && ConsoleJoystick.player.GetButtonDown(RewiredConsts.Action.UseVent))
        ...
        else
        {
            ...
            if (PlayerControl.LocalPlayer.Data != null && PlayerControl.LocalPlayer.Data.Role != null)
            {
                ...
                if (PlayerConditions.CanUseVentButtonKeyBind(PlayerControl.LocalPlayer) && ConsoleJoystick.player.GetButtonDown(RewiredConsts.Action.UseVent))
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.DoClick();
            }
        }
